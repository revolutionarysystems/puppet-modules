define subscription-manager ($version="LATEST", $deploy_name="subscription-manager", $db_host="localhost", $db_name="subscription-manager", $templates_version="LATEST", $views_version="LATEST", $instance_container="", $instance_path="", $user_manager_db_host="", $security="default", $security_administrator_role="subscription-manager:administrator"){
  ...
  $view_repository_type = "cloud"
  $view_container = "revsys-haven-artifacts"
  $view_path = "subscription-manager-views/${views_version}/artifact"
