class user-manager ($version="LATEST", $repo="snapshots", $deploy_name="user-manager", $db_host="localhost", $cloud_identity="", $cloud_credential="", $config_container="", $config_path="", $resources_container=""){
