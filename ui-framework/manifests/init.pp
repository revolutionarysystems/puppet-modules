define ui-framework ($version="LATEST", $deploy_name="ui-framework", $repository_type="cloud", $resources_container="", $resources_path="", $security_filters="none", $user_manager_url="", $login_url="login.html", $login_success_url="index.html"){
