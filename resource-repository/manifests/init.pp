class resource-repository ($version="LATEST", $deploy_name="resource-repository", $repository_type="cloud", $resource_container="", $security="disabled", $security_role="", $user_manager_db_host=""){
